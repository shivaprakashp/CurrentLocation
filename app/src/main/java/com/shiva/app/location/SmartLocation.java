...
public class SmartLocation implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    private LocationInterface mLocationManagerInterface;
...
//    private final double STANDARD_LOCATION_SEED_LIMIT = 6.95;
    ...
    public SmartLocation(Context context, Activity activity,
                                LocationInterface locationInterface,
                                int providerType, int locationPiority,
...
//        askLocationPermission();                            // for android version 6 above
    ...
    private void setNewLocation(Location location, Location oldLocation) {
        if (location != null) {
            ...
            mLocationManagerInterface.locationFetch(location, mLastLocationFetched, mLastLocationUpdateTime, location.getProvider());
        }
    }
    ...
    public void captureLocation() {
        ...
        try {
            if (mProviderType == SmartLocation.GPS_PROVIDER) {
                locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 0, 0, locationListener);
            } else if (mProviderType == SmartLocation.NETWORK_PROVIDER) {
